...
public abstract class WeightedBlockStateProviderMixin {
    ...
    @WrapOperation(
            ...
            at = @At(
                    value = "INVOKE",
                    target = "Lnet/minecraft/util/WeightedList;add(Ljava/lang/Object;I)Lnet/minecraft/util/WeightedList;"
            )
    )
    ...
    @WrapOperation(
            ...
            at = @At(
                    value = "INVOKE",
                    target = "Lnet/minecraft/util/WeightedList;pickRandom(Ljava/util/Random;)Ljava/lang/Object;"
            )
    )
